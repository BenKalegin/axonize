  ...
  try {
    ...
    return {
      ...
      agent: {
        ...
        ...parsed.agent,
        providerSettings: {
          ...DEFAULT_SETTINGS.agent.providerSettings,
          ...(parsed.agent?.providerSettings ?? {})
        }
      },
      ...
      appearance: { ...DEFAULT_SETTINGS.appearance, ...(parsed.appearance ?? {}) } as NonNullable<AppSettings['appearance']>,
    }
  } catch {
